...
{
    internal unsafe sealed class Sqlncl11Driver : OdbcDriver
    {
        private static class NativeMethods
        {
            #region sqlncli11.dll

            [DllImport("sqlncli11.dll", SetLastError = false)]
            ...
            [DllImport("sqlncli11.dll", CharSet = CharSet.Unicode, SetLastError = false)]
        ...
        private static readonly Sqlncl11Driver Instance = new Sqlncl11Driver();

        private Sqlncl11Driver()
        {
            //
        }

        public static Sqlncl11Driver SingleInstance
        {
            get { return Instance; }
        }
        ...
        {
            get { return "Driver={SQL Server Native Client 11.0}"; }
        }
